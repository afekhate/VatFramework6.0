...
namespace VatFramework.Utilities.Extensions.Permission
{
    ...
    {
        public PermissionDisplay(string groupName, string name, string description, TranspecsPermissions permission
            /*string moduleName*/)
        {
        ...
        /// </summary>
        public TranspecsPermissions Permission { get; private set; }
        /// <summary>
        ...
        public static List<PermissionDisplay> GetPermissionsToDisplay(Type enumType)
        {
            ...
            foreach (var permissionName in Enum.GetNames(enumType))
            {
                ...
                var permission = (TranspecsPermissions)Enum.Parse(enumType, permissionName, false);
